const camundaRestEndpoint = 'https://6228-2a02-8071-3ed0-bb00-a81b-df45-9d50-e18e.ngrok.io';
const invocationName = 'pizza tasks';
...
zip.folder("lambda").file("index.js", lambdaNodeJS).file("package.json", lambdaNodeJSPackageJson);
zip.folder("skill-package").folder("interactionModels").folder("custom").file("de-DE.json", interactionModelDE);
